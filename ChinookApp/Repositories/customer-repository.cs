...
namespace ChinookApp.Repositories
{
    ...
    public class CustomerRepository : ICustomerRepository
    {
        ...
        public List<CustomerGenre> GetMostPopularGenreForCustomer(int customerId)
        {
            ...
            MaxCounts AS (
                SELECT CustomerId, MAX(PurchaseCount) as MaxCount
            ...
            SELECT 
                ...
                cgc.GenreName, 
                cgc.PurchaseCount
            FROM CustomerGenreCounts cgc
            JOIN MaxCounts mc ON cgc.CustomerId = mc.CustomerId
            WHERE cgc.PurchaseCount = mc.MaxCount
            ORDER BY cgc.GenreName", connection);
